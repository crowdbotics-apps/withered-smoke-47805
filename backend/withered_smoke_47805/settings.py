"""
Django settings for withered_smoke_47805 project.
...
ROOT_URLCONF = 'withered_smoke_47805.urls'
...
WSGI_APPLICATION = 'withered_smoke_47805.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_smoke_47805 API",
    "DESCRIPTION": "API documentation for withered_smoke_47805 App",
    "VERSION": "v1",
}
